...
export default async function KampoengIndonesiaRestaurantsPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  return (
    <RestaurantVenuePage
      ...
      hero={{
        ...
        image: {
          // Façade (1.78) — not guest-bedroom interior.jpg. No published dining-room asset.
      ...
      gallery={{
        ...
        images: [
          {
            src: "/images/kampoeng-indonesia/courtyard.jpg",
            alt: t("alt.g1"),
          },
          {
            src: "/images/kampoeng-indonesia/facade-day.jpg",
          ...
          // Guest-room atmosphere only — not a dining interior; kept last, honest alt.
          {
            src: "/images/kampoeng-indonesia/interior.jpg",
            alt: t("alt.g4"),
          },
        ],
      }}
