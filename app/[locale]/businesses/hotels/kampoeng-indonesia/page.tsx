...
export async function generateMetadata({
  ...
  const t = await getTranslations({
    locale,
    namespace: "businesses.hotels.properties.kampoeng",
  });
  return {
    title: t("meta.title"),
...
export default async function KampoengIndonesiaHotelPage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  const t = await getTranslations("businesses.hotels.properties.kampoeng");
